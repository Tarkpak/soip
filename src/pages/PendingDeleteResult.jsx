...
const domains = [
  {id: '1', name: 'abcdefghijklmnopqrstuvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '2', name: 'abcdeqrstuvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '3', name: 'ijklmnopqrstuvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '4', name: 'abtuvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '5', name: 'efghijklmnopqrstuvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '6', name: 'eqrstuvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '7', name: 'defghijklmnopqrstuvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '8', name: 'aeqrstuvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '9', name: 'imnopqrstuvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '10', name: 'uvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '11', name: 'uvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  {id: '12', name: 'uvwxyz.com', da: 100, backlink: 123456789, rd: 123456, years: 88, aby: 1988, acr: 655555, cat:'search engine', word:'1', rank:1234567, tld:'com', dropdate:'08-08-2022'},
  // More people...
]
              ...
              <div className="bg-white">
                  {domains.map((dom,domIdx) => (
                    <div key={dom.id} className="min-w-full border-collapse text-center truncate flex even:bg-green-50 !bg-opacity-40 hover:bg-gray-200">
                      ...
                      <div className="whitespace-nowrap py-2 text-xs text-gray-500 border border-gray-200 w-4-50 truncate hidden md:block">{dom.rd}</div>
                      <div className={classNames(
                          dom.years > 20 ? 'text-green-700 font-semibold whitespace-nowrap py-2 text-xs text-gray-500 border border-gray-200 w-3-50 truncate w-1-10' : 'whitespace-nowrap py-2 text-xs text-gray-500 border border-gray-200 w-3-50 truncate w-1-10'
                        )}> 
                        {dom.years}
                      </div>
                      <div className="whitespace-nowrap py-2 text-xs text-gray-500 border border-gray-200 w-3-50 truncate hidden md:block">{dom.aby}</div>
                      <div className="whitespace-nowrap py-2 text-xs text-gray-500 border border-gray-200 w-4-50 truncate hidden md:block">{dom.acr}</div>
